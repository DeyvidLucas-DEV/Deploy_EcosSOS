...
public interface IOcorrenciaController {
    ...
    ResponseEntity<OcorrenciaDTO> criar(@Valid @RequestBody OcorrenciaCreateDTO ocorrenciaCreateDTO) throws Exception;
    ...
    ResponseEntity<OcorrenciaDTO> editarParaAdmin(@PathVariable("idOcorrencia") Integer idOcorrencia,
    ...
    ResponseEntity<OcorrenciaDTO> editarParaComum(@PathVariable("idOcorrencia") Integer idOcorrencia,
                                                  @Valid @RequestBody OcorrenciaUpdateDTO ocorrenciaAtulizar) throws Exception;
    ...
    ResponseEntity<Void> remover(@PathVariable("idOcorrencia") Integer idOcorrencia) throws Exception;
    @Operation(
            summary = "Deletar ocorrência",
    ...
    @DeleteMapping("/{idOcorrencia}")
    ResponseEntity<Void> removerParaComum(@PathVariable("idOcorrencia") Integer idOcorrencia) throws Exception;
}

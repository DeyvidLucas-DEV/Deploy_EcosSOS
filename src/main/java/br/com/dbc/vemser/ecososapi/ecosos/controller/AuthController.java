...
public class AuthController implements IAuthController {
    ...
    public ResponseEntity<UsuarioDTO> adicionar(@RequestBody @Valid UsuarioCreateDTO usuarioCreateDTO) throws Exception {
        return ResponseEntity.ok(usuarioComumService.adicionar(usuarioCreateDTO));
    }
